...
- `discuss/discuss.js` - 页面逻辑
- `discuss/discuss.css` - 页面样式

### 修改文件
- `manifest.json` - 添加 tabs 权限
- `background/background.js` - 添加讨论状态存储
- `sidebar/sidebar.html` - 添加模式选择
- `sidebar/sidebar.js` - 添加打开实时页面逻辑
- `shared/state.js` - 添加讨论状态
